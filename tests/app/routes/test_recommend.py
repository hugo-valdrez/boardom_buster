...
from src.app.routes.recommend import router, get_recommendations
from src.app.schemas import RecommendationRequest, GameResponse
...
class TestGetRecommendations:
    ...
    def test_get_recommendations_response_structure(self, mock_recommender, sample_recommendation_data):
