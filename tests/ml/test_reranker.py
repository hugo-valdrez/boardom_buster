...
from src.ml.reranker import ReRankerConfig, ReRanker, Columns
...
class TestReRanker:
    ...
    def test_rerank_normalizes_scores(self, sample_input_game, sample_candidates):
        ...
        for col in [Columns.NORM_YEAR_SIMILARITY, Columns.NORM_PLAYING_TIME_SIMILARITY,
                    Columns.NORM_AVG_RATING, Columns.NORM_POPULARITY]:
    ...
    def test_rerank_uses_bayesian_rating_when_available(self, sample_input_game, sample_candidates):
        ...
        reranker = ReRanker()
        weights = {"weight_cosine_similarity": 0, "weight_year_similarity": 0,
                  "weight_playing_time_similarity": 0, "weight_rating": 1.0,
                  "weight_popularity": 0}
    ...
    def test_rerank_falls_back_to_avg_rating(self, sample_input_game):
        ...
        result = reranker.rerank(sample_input_game, candidates_no_bayesian, top_k=2, weights=weights)
    ...
    def test_compute_final_score_with_custom_weights(self, sample_input_game, sample_candidates):
        ...
        weights_cosine = {"weight_cosine_similarity": 1.0, "weight_year_similarity": 0,
                         "weight_playing_time_similarity": 0, "weight_rating": 0,
                         "weight_popularity": 0}
        
        result1 = reranker.rerank(sample_input_game, sample_candidates, top_k=3, weights=weights_cosine)
        
        # All weight on popularity
        weights_pop = {"weight_cosine_similarity": 0, "weight_year_similarity": 0,
                      "weight_playing_time_similarity": 0, "weight_rating": 0,
                      "weight_popularity": 1.0}
        
        result2 = reranker.rerank(sample_input_game, sample_candidates, top_k=3, weights=weights_pop)
